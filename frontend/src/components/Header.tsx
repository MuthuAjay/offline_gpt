  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {showSearchInput && showCustomSearch && (
        <div className="web-search-input-container custom-search-input-container mb-2 bg-emerald-50 dark:bg-emerald-900/20">
          <div className="flex items-center px-3 py-2">
            ...
            <input 
              type="text"
              ref={searchInputRef}
              className="web-search-input flex-grow text-emerald-700 dark:text-emerald-300 placeholder-emerald-400"
        ...
        <div className="chat-input-actions">
          ...
          {onToggleWebSearch && (
            <button
              ...
              className={`chat-input-button web-search-toggle ${webSearchEnabled ? 'text-emerald-600 bg-emerald-100 dark:text-emerald-400 dark:bg-emerald-900/30' : ''}`}
          ...
          {showSearchInput && webSearchEnabled && (
            <button
              type="button"
              className={`chat-input-button ${showCustomSearch ? 'text-emerald-600 bg-emerald-100 dark:text-emerald-400 dark:bg-emerald-900/30' : ''}`}
          ...
          <button
            type="button"
            className="send-button bg-amber-600 hover:bg-amber-700"
      ...
      {webSearchEnabled && !disabled && (
        <div className="web-search-badge mt-2 ml-1 text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20">
